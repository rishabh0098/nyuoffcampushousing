...
export const NEIGHBORHOOD_LABELS: Record<Neighborhood, string> = {
  ...
  BatteryParkCity: "Battery Park City",
  UnionSquare: "Union Square",
  Gramercy: "Gramercy",
  Flatiron: "Flatiron",
  Chelsea: "Chelsea",
  HellKitchen: "Hell's Kitchen",
  ...
  BoerumHill: "Boerum Hill",
  CobbleHill: "Cobble Hill",
  CarrollGardens: "Carroll Gardens",
  ParkSlope: "Park Slope",
  ProspectHeights: "Prospect Heights",
  BedfordStuyvesant: "Bedford-Stuyvesant",
